        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    <Link
                        href="/login"
                        className="px-5 py-2 text-sm font-medium text-slate-700 border border-slate-200 rounded-full hover:border-brand-cyan hover:text-brand-cyan hover:shadow-[0_0_15px_rgba(165,243,252,0.5)] transition-all duration-300"
                    >
                        Login
                    </Link>
                </div>
