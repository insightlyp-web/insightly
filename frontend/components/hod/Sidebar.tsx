...
const navigation = [
  { name: "Dashboard", href: "/hod/dashboard", icon: "📊" },
  { name: "Students", href: "/hod/students", icon: "👥" },
  { name: "Faculty", href: "/hod/faculty", icon: "👨‍🏫" },
  { name: "Courses", href: "/hod/courses", icon: "📚" },
  { name: "Map Courses", href: "/hod/courses/map", icon: "🔗" },
  { name: "Timetable", href: "/hod/timetable", icon: "📅" },
  { name: "Attendance Analytics", href: "/hod/attendance", icon: "📈" },
];
